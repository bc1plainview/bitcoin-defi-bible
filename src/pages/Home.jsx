    ...
    <div className="home">
      <section className="hero">
        ...
        <h1 className="hero-title">
          {t('THE BITCOIN DEFI BIBLE', '比特币 DEFI 圣经')}
        </h1>

        <p className="hero-subtitle animate-fade-up stagger-3">
          {t('SlowFi Season Has Arrived', 'SlowFi 时代已经到来')}
        </p>

        <p className="hero-tagline animate-fade-up stagger-4">
          {t(
        ...
        <div className="hero-cta animate-fade-up stagger-5">
          <Link to="/docs/introduction" className="btn btn-primary btn-glow">
        ...
        <div className="hero-quick-nav animate-fade-up stagger-6">
          <p className="hero-quick-nav-label">{t('Jump to a topic', '跳转到主题')}</p>
          <div className="hero-quick-nav-links">
            <Link to="/docs/tldr" className="quick-nav-chip">TLDR</Link>
            <Link to="/docs/what-is-slowfi" className="quick-nav-chip">
              {t('SlowFi Thesis', 'SlowFi 理论')}
            </Link>
            <Link to="/docs/motoswap" className="quick-nav-chip">Motoswap</Link>
            <Link to="/docs/nativeswap" className="quick-nav-chip">NativeSwap</Link>
      ...
      <section className="features-section">
        <h2 style={{ textAlign: 'center', borderBottom: 'none', marginBottom: '1.5rem' }}>
          {t('The DeFi Summer Playbook, Now on Bitcoin', 'DeFi Summer 攻略，现在在比特币上')}
        </h2>
        <p style={{ textAlign: 'center', maxWidth: '700px', margin: '0 auto 3rem', color: 'var(--text-tertiary)', fontSize: '1.05rem', lineHeight: '1.8' }}>
          {t(
      ...
      <section className="home-section" style={{ padding: '4rem 2rem', textAlign: 'center' }}>
        <div className="home-section-card" style={{ maxWidth: '500px', margin: '0 auto' }}>
          ...
          <p style={{ color: 'var(--btc-orange)', marginBottom: '1.5rem', fontSize: '1.15rem', fontWeight: 700 }}>
      ...
      <footer className="home-footer">
        ...
        <p style={{ marginBottom: '0.5rem' }}>
          ...
          {' · '}
          <a href="https://opnet.org" target="_blank" rel="noopener noreferrer">OP_NET</a>
          {' · '}
          <a href="https://docs.opnet.org" target="_blank" rel="noopener noreferrer">{t('Docs', '文档')}</a>
          {' · '}
          <a href="https://opscan.org" target="_blank" rel="noopener noreferrer">OPScan</a>
          {' · '}
          <a href="https://optools.org" target="_blank" rel="noopener noreferrer">OPTools</a>
          {' · '}
          <a href="https://chromewebstore.google.com/detail/opwallet/pmbjpcmaaladnfpacpmhmnfmpklgbdjb?hl=en" target="_blank" rel="noopener noreferrer">OP_WALLET</a>
        </p>
        <p style={{ marginBottom: 0 }}>
          <a href="https://x.com/opnetbtc" target="_blank" rel="noopener noreferrer">@opnetbtc</a>
          {' · '}
          <a href="https://x.com/Motoswap" target="_blank" rel="noopener noreferrer">@Motoswap</a>
          {' · '}
          <a href="https://x.com/bc1plainview" target="_blank" rel="noopener noreferrer">@bc1plainview</a>
          {' · '}
          <a href="https://github.com/btc-vision" target="_blank" rel="noopener noreferrer">GitHub</a>
        </p>
      </footer>
    </div>
  )
